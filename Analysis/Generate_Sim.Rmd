...
for(j in 1:length(y.norm))
{
  mydata[[j]]<-data.frame(t(data.frame(y.norm[[j]][["0"]],
              y.norm[[j]][["0.01"]],y.norm[[j]][["0.03"]],                                 y.norm[[j]][["0.1"]],y.norm[[j]][[5]],
                   y.norm[[j]][["0.3"]],y.norm[[j]][["1"]],
          y.norm[[j]][["3"]],y.norm[[j]][["10"]],y.norm[[j]][["30"]])),
