...
simulated.data<-logcounts(simD.list.sparse$`Stellate Cells 0.1 3 0.166333915535776:0.036722537282455:0.162386642853367:0.118449235819558:0.0998655050227872:0.0558323104597242:0.0606977613975638:0.182516827781538:0.117195263847231`)
simulated.cell.metadata<-colData(simD.list.sparse$`Stellate Cells 0.1 3 0.166333915535776:0.036722537282455:0.162386642853367:0.118449235819558:0.0998655050227872:0.0558323104597242:0.0606977613975638:0.182516827781538:0.117195263847231`)
simulated.gene.metadata<-rowData(simD.list.sparse$`Stellate Cells 0.1 3 0.166333915535776:0.036722537282455:0.162386642853367:0.118449235819558:0.0998655050227872:0.0558323104597242:0.0606977613975638:0.182516827781538:0.117195263847231`)
...
value1<-c(31,6,545,274,47,3,529,277,71,96,505,184,115,133,461,147,
          202,172,374,108,284,269,292,11,471,280,105,0,576,283,0,0)
...
method <- c(rep("BF" , 4) , rep("Anova" , 4) , rep("KW" , 4) , rep("Wilcox" , 4) , rep("MAST" , 4),rep("LRT_mult" , 4))
type <- rep(c("TP" , "FP" , "FN","TN") , 6)
value1<-c(556,280,1579,18981,1704,6040,451,13221,1724,6511,431,12750,1755,8694,380,10567,
          1749,6202,406,13059,1806,11189,349,8072)
...
type <- rep(c("TP" , "FP" , "FN","TN") , 6)
value<-c(489,280,1666,18981,496,288,1659,18973,496,288,1659,18973,522,288,1633,18973,
         53,223,2102,19038,496,288,1659,18973)
