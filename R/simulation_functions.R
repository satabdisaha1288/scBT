simHill = function(doses, mean.range, fc.range = c(1.5, 5), downregulated = FALSE){
...
simExp = function(doses, mean.range, fc.range = c(1.5, 5), downregulated = FALSE, power = FALSE){
...
simExpB = function(doses, mean.range, fc.range = c(1.5, 5), downregulated = FALSE){
