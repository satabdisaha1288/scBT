...
```{r}
significantGenes = getDEGs(sim, All, threshold = 0.05, fc.threshold = 0, bayes.threshold = 1/10, pct.expressed = 0)
```

2) EXtract 'truth'
```{r}
trueDEGs = TruthFromSim(sim, fc.threshold = 0, pct.expressed = 0)
```
